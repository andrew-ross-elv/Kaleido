...
/// <summary>
/// KAL1009 G현 every testable type in the source assembly must have a
...
public sealed class FixtureCoverageAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly DiagnosticDescriptor Rule =
        new(
            ...
            "Type '{0}' in '{1}' has no '{2}' fixture G현 every testable type must have a unit-test fixture",
            "Kaleido.Tests",
    ...
    private static bool IsTestable(INamedTypeSymbol type)
    {
        ...
        // [ExcludeFromCodeCoverage] is the explicit opt-out signal G현 the type is
        ...
        // need a reference to the attribute G현 the symbol comes from the analysed compilation.
        ...
        // (registered services always qualify G현 services have methods)
