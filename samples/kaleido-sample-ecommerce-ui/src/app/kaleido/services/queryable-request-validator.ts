...
export class QueryableRequestValidationError
    extends Error {
    ...
    constructor(
        ...
        super(
            'Queryable request validation failed.');
    }
}
    ...
    if (
      ...
      return {
        parameter:
          parameter.name,
        message:
          `${parameter.name} must be at least ${minimumLength} characters.`
      };
    }
    ...
    if (
      ...
      return {
        parameter:
          parameter.name,
        message:
          `${parameter.name} must be no more than ${maximumLength} characters.`
      };
    }
    ...
    if (
      ...
      return {
        parameter:
          parameter.name,
        message:
          `${parameter.name} must be greater than or equal to ${minimum}.`
      };
    }
    ...
    if (
      ...
      return {
        parameter:
          parameter.name,
        message:
          `${parameter.name} must be less than or equal to ${maximum}.`
      };
    }
