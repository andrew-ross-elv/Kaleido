namespace Kaleido.Client;

/// <summary>
/// Kaleido client configuration options, bound from the <c>Kaleido</c> configuration section.
...
public sealed class KaleidoClientOptions : KaleidoOptions
{
    ...
    /// Addresses are resolved from <c>ReverseProxy:Clusters</c> — no URL duplication.
    /// Used by <see cref="KaleidoRegistryServiceCollectionExtensions.AddKaleidoRegistry"/>.
    /// </summary>
