...
- [`KaleidoProcessClientServiceCollectionExtensions`](./KaleidoProcessClientServiceCollectionExtensions.cs) — `AddProcessClient(name, baseUrl)` and `AddProcessClients(names...)` builder extensions
