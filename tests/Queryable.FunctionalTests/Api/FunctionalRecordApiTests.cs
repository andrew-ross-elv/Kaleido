...
//public sealed class FunctionalRecordApiTests
//    : IClassFixture<FunctionalApiFixture>
//{
//    private readonly FunctionalApiFixture _fixture;
//    private readonly JsonSerializerOptions _jsonOptions;

//    public FunctionalRecordApiTests(
//        FunctionalApiFixture fixture)
//    {
//        _fixture = fixture;
...
//        var records =
//            await client.GetFromJsonAsync<IReadOnlyList<RecordMetadata>>(
//                "/v1/records",
//                _jsonOptions);
...
//    public async Task Api_Query_Should_Produce_Expected_Result(
...
//        var apiResponse =
//            JsonSerializer.Deserialize<ApiFunctionalQueryResponse>(
//                content,
//                _jsonOptions);
...
//        RecordMetadata RuntimeMetadata,
//        int TotalCount,
